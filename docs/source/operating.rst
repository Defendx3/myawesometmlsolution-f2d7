[myawesometmlsolution-f2d7] Operating Details
====================================

Generated On: 2024-10-31 17:09:00 UTC
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-f2d7] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=44639  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='defendx3@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   defendx/myawesometmlsolution-f2d7-amd64 (https://hub.docker.com/r/defendx/myawesometmlsolution-f2d7-amd64)
...
.. important::
   docker run -d -p 43563:43563 -p 47487:47487 -p 41937:41937 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-f2d7 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-f2d7 \-\-env GITUSERNAME=Defendx3  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=43563  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=47487  \-\-env SOLUTIONVIPERVIZPORT=41937 \-\-env DOCKERUSERNAME='defendx'  \-\-env EXTERNALPORT=44639 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='defendx3@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  defendx/myawesometmlsolution-f2d7-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=41937
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=43563
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - defendx/myawesometmlsolution-f2d7-amd64
...
It can be accessed by entering: http://localhost:47487
...
.. important::
   http://localhost:41937/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:41937/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:41937/<html file>
...
[myawesometmlsolution-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-f2d7
...
.. important::
   https://myawesometmlsolution-f2d7.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-f2d7
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.1, VIPERPORT_PRODUCE=43563, VIPERHOST_PREPOCESS=172.17.0.1, VIPERPORT_PREPROCESS=34415, VIPERHOST_PREPOCESS2=172.17.0.1, VIPERPORT_PREPROCESS2=43861, VIPERHOST_PREPOCESS_PGPT=172.17.0.1, VIPERPORT_PREPROCESS_PGPT=36663, VIPERHOST_ML=172.17.0.1, VIPERPORT_ML=46301, VIPERHOST_PREDCT=172.17.0.1, VIPERPORT_PREDICT=32999, HPDEHOST=172.17.0.1, HPDEPORT=37369, HPDEHOST_PREDICT=172.17.0.1, HPDEPORT_PREDICT=40613

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7154-myawesometmlsolution-f2d7,solution_preprocessing_dag-myawesometmlsolution-f2d7, python-preprocess-9199-myawesometmlsolution-f2d7,solution_preprocessing_dag-myawesometmlsolution-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
